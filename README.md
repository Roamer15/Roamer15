# 👋 Hi, I'm Beleke Ian Langeh

Full-Stack Developer focused on building products that solve real problems.
I've spent the last year and a half going from zero to shipping — 
building a streaming platform, a SaaS backend, a chess app with an AI engine, 
...
[![CoderLegion](https://coderlegion.com/cl_badge_logo1.png)](https://coderlegion.com/user/Roamer_15)
## 🛠 Tech Stack
...
|---------|-------------|-------|-------|
| **Seendr** | Video-first friendship app connecting people through shared interests. Built to bring genuine human connection back to social media. | React Native · Django · PostgreSQL · Redis · WebRTC | [APK](https://seendr.vercel.app) · [Repo](#) |
| **Appointment Booking API** | Production-ready REST API connecting clients and service providers with JWT auth, real-time notifications, and Swagger docs. | Node.js · Express · PostgreSQL · Socket.IO | [Demo](https://nexmeet-seven.vercel.app/) · [Repo](https://github.com/Roamer15/Appointment-backend-api) |
| **ChwiiX** | Streaming discovery platform for movies and TV shows with genre browsing and trailer playback powered by the TMDB API. | React · TypeScript · Tailwind · TMDB API | [Demo](https://chwiix.vercel.app) · [Repo](https://github.com/Roamer15/streamx) |
